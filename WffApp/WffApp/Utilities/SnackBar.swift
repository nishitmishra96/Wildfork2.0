...
open class SnackBar: UIView {
    ...
    public typealias TTGActionBlock = (_ snackbar:SnackBar) -> Void
    
    /// Dismiss callback closure definition.
    public typealias TTGDismissBlock = (_ snackbar:SnackBar) -> Void
    
    /// Swipe gesture callback closure
    public typealias TTGSwipeBlock = (_ snackbar: SnackBar, _ direction: UISwipeGestureRecognizer.Direction) -> Void
